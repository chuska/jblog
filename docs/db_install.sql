...
(
	...
	COMMENTS_USER_NAME VARCHAR2(100) NOT NULL,
	POST_NO NUMBER(10) NOT NULL,
	CONTENT VARCHAR2(1000),
	CREATED_DATE DATE,
...
INSERT INTO CATEGORY (BLOG_NO, CATEGORY_NO, CATEGORY_NAME,DISPLAY_TYPE, CNT_DISPLAY_POST, DESCRIPTION, CREATED_DATE, MODIFIED_DATE) 
		       VALUES(3, CATEGORY_SEQ.NEXTVAL, '여행','TYPE', 1, '잘못만듬', SYSDATE, SYSDATE);
			   		   
INSERT INTO CATEGORY (BLOG_NO, CATEGORY_NO, CATEGORY_NAME,DISPLAY_TYPE, CNT_DISPLAY_POST, DESCRIPTION, CREATED_DATE, MODIFIED_DATE) 
		       VALUES(3, CATEGORY_SEQ.NEXTVAL, '축구','TYPE', 1, '잘못만듬', SYSDATE, SYSDATE);
